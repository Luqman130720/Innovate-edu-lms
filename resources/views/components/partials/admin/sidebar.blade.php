        ...
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                ...
                <div class="collapse" id="userManagementDropdown">
                    <ul class="nav flex-column ms-4">
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('operator.students.index') }}">
                                <span class="nav-link-text">Tambah Data Siswa</span>
                            </a>
                        </li>
                    </ul>
                </div>
            ...
            <li class="nav-item">
                <a class="nav-link" href="#" data-bs-toggle="collapse" data-bs-target="#subjectDataDropdown"
                    ...
                    <span class="nav-link-text ms-1">Manajemen Mapel</span>
                </a>
                <div class="collapse" id="subjectDataDropdown">
                    <ul class="nav flex-column ms-4">
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('operator.subjects.index') }}">
                                <span class="nav-link-text">Tambah Data Mapel</span>
                            </a>
                        </li>
                    </ul>
                </div>
